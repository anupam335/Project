...
const CustNavbarProfile = (props) => {
  const url=`/profile/ViewProfileCust/${props.id}`;
  ...
  return (
    <Navbar bg="dark" variant="dark">
      ...
      <Form inline>
        <Link to="/profile/CUSTOMER"><Button className="mr-xl-5">Home</Button></Link>
...
export default CustNavbarProfile;